---
title: "EC and WGU Base Binary SuperLearners"
...
The purpose of this document is to generate SuperLearner objects for all base binary variables for EC and WGU.
...
```{r}
model_title <- "ec_base_SuccessTerm1"
explanatory_training_set <- ec_base_trn
...
```{r}
model_title <- "ec_base_SuccessTerm2"
explanatory_training_set <- ec_base_trn
...
```{r}
model_title <- "ec_base_CreditRatio_Term1"
explanatory_training_set <- ec_base_trn
...
```{r}
model_title <- "ec_base_CreditRatio_Term2"
explanatory_training_set <- ec_base_trn
...
```{r}
model_title <- "wgu_base_OnTime_Term1"
explanatory_training_set <- wgu_base_trn
...
```{r}
model_title <- "wgu_base_OnTime_Term2"
explanatory_training_set <- wgu_base_trn
...
```{r}
model_title <- "wgu_base_CreditRatio_Term1"
explanatory_training_set <- wgu_base_trn
...
```{r}
model_title <- "wgu_base_CreditRatio_Term2"
explanatory_training_set <- wgu_base_trn
